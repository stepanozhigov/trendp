...
<head>
    ...
    <title>{{ config('app.name', 'Создание сайтов в Москве без предоплаты') }}</title>
...
<body class="{{ strpos( $_SERVER['HTTP_ACCEPT'], 'image/webp' ) !== false ? 'webp' : '' }}">
    
    <div id="app">
        <layout></layout>
    </div>

    <script src="/js/app_frontend.js"></script>
